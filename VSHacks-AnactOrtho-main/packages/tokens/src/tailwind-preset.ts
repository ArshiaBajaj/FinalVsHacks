...
export const tailwindPreset = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "court-hero":
          "radial-gradient(60% 45% at 15% 5%, rgba(255,91,31,0.14) 0%, rgba(0,0,0,0) 60%), radial-gradient(50% 40% at 92% 90%, rgba(57,255,20,0.14) 0%, rgba(0,0,0,0) 60%)",
        "grid-diffuse":
          "linear-gradient(rgba(163,163,163,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(163,163,163,0.04) 1px, transparent 1px)",
      },
    },
  },
};
