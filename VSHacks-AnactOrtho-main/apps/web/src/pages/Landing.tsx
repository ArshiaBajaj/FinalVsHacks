      ...
      <div className="relative mx-auto flex min-h-[calc(100dvh-1.25rem)] max-w-[1400px] flex-col overflow-hidden rounded-[28px] border border-white/10 shadow-frame md:min-h-[calc(100dvh-2.5rem)] md:rounded-[32px]">
        <div className="absolute inset-0">
          <img
            src="/hero-court.jpg"
            alt=""
            className="h-full w-full object-cover object-center brightness-[0.72] contrast-[1.08] saturate-[0.55] hue-rotate-[-12deg]"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/55 to-black/92" />
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent" />
          <div
            aria-hidden
            className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.45)_0%,rgba(255,91,31,0.08)_40%,transparent_72%)]"
          />
        </div>
        ...
        <header className="relative z-20 flex items-center justify-between gap-3 px-5 py-5 md:px-8 md:py-6">
          <Link to="/" className="flex items-center gap-2.5" aria-label="Anact Ortho home">
            <CourtMark />
            <span className="hidden font-brand text-lg tracking-wide sm:inline" style={{ color: "var(--court-neon)" }}>
              Anact <span style={{ color: "var(--court-accent2)" }}>Ortho</span>
            </span>
          </Link>
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-6 pt-4 text-center md:pb-2 md:pt-0">
          ...
          >
            <h1
              className="font-brand text-[clamp(3.5rem,14vw,9.5rem)] leading-[0.85] tracking-[0.02em]"
              style={{ color: "var(--court-neon)" }}
            >
              ANACT
              <span style={{ color: "var(--court-accent2)" }}> ORTHO</span>
            </h1>
          ...
          {FEATURES.map((f, i) => {
            ...
            return (
              ...
              >
                  ...
                  <>
                    <img
                      ...
                      className={`absolute inset-0 h-full w-full object-cover ${
                        f.to === "/film"
                          ? "object-top opacity-70 brightness-[0.75] saturate-[0.6]"
                          : "opacity-55"
                      }`}
                    />
                ...
                <Link
                  to={f.to}
                  className="btn-primary relative flex w-full items-center justify-between rounded-none rounded-b-[22px] px-5 py-3.5 text-sm"
                >
  ...
  return (
    <svg width="28" height="28" viewBox="0 0 32 32" fill="none" aria-hidden>
      ...
      <path
        ...
        fill="none"
      />
      <circle cx="22" cy="10" r="2" fill="#ff5b1f" />
    </svg>
  );
}
