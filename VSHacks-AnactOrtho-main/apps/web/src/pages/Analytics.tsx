      ...
      <section className="grid gap-4 md:grid-cols-[1.4fr_1fr]">
        <div className="panel p-6">
          ...
          <div className="flex items-center justify-between gap-6">
            ...
            <TeamPill team="B" score={dataScoreB} color="#39ff14" won={dataScoreB > dataScoreA} />
          </div>
      ...
      <section className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
        <div className="panel overflow-hidden !p-0">
          ...
          <div className="flex flex-wrap items-center gap-2 border-t border-white/10 px-5 py-3 md:px-6">
            ...
            <span className="chip">
              <Flame className="h-3 w-3 text-court-neon" /> Defense density
            </span>
            <span className="chip">
...
function MomentumChart({
  ...
  return (
    <svg viewBox={`0 0 ${w} ${h}`} className="w-full">
      ...
      <text x="4" y={h - 6} fontSize="9" fill="#39ff14" opacity="0.8">Team B up</text>
    </svg>
  );
}
      ...
      >
        <defs>
          ...
          <radialGradient id="densityCloud" cx="28%" cy="42%" r="35%">
            ...
            <stop offset="45%" stopColor="#ff5b1f" stopOpacity="0.22" />
            <stop offset="100%" stopColor="#ff5b1f" stopOpacity="0" />
          </radialGradient>
          <linearGradient id="flowStroke" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#39ff14" stopOpacity="0" />
            <stop offset="40%" stopColor="#39ff14" stopOpacity="0.85" />
